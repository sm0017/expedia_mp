...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
names(exp_Data)
column_var = c ("user_id", "is_mobile", "is_package", "srch_destination_id", "is_booking", 
                "hotel_cluster", "is_alone", "hotel_market", "year", "month", "day","hour"                     
                ,"part_of_day", "type_of_day", "season", "duration_of_stay", "hotel_market", "hotel_continent")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#write.csv(expData_dat1, "/home/smita/MP/dataSet2014_RF.csv")
print("Done!")
